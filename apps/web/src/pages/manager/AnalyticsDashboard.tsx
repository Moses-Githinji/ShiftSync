...
export function AnalyticsDashboard() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-6 py-4 md:py-6">
              ...
              <CardContent className="pt-4 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">{warning.type} ΓÇó {warning.count} issue(s)</p>
                  </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="px-4 lg:px-6 w-full flex gap-1 flex-col h-[calc(100vh-200px)]">
        <TabsList className="gap-1 bg-none">
